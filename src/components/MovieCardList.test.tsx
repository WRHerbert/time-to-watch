...
test('renders no movie card', () => {
  ...
  expect(queryByText(movieA.runtime.toString())).not.toBeInTheDocument()
  expect(queryByText(movieB.title)).not.toBeInTheDocument()
  expect(queryByText(movieB.runtime.toString())).not.toBeInTheDocument()
})
...
test('renders single movie card', () => {
  ...
  expect(queryByText(movieA.runtime.toString())).toBeInTheDocument()
  expect(queryByText(movieB.title)).not.toBeInTheDocument()
  expect(queryByText(movieB.runtime.toString())).not.toBeInTheDocument()
})
...
test('renders multiple movie cards', () => {
  ...
  expect(queryByText(movieB.runtime.toString())).toBeInTheDocument()
})
